...
require('packer').startup(function(use)
  ...
  use 'wbthomason/packer.nvim' -- Manage packer using packer!
...
lspconfig.gopls.setup {
  on_attach = function(client, bufnr)
    -- Optional: Keymaps for LSP navigation
...
require('Comment').setup {
  toggler = {
    line = 'gcc', -- Toggle comment on the current line
    block = 'gbc', -- Toggle comment on a block (useful for multi-line comments)
  },
  opleader = {
